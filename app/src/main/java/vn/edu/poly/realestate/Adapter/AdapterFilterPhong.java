...
import vn.edu.poly.realestate.Model.ModelDangTinBatDongSan.ContructoFiltePhong;
import vn.edu.poly.realestate.Model.ModelFilter.ContructoFilterChonhuong;
import vn.edu.poly.realestate.R;

public class AdapterFilterPhong extends BaseAdapter {
    LayoutInflater inflater ;
    Context context;
    ArrayList<ContructoFiltePhong> arrayList;

    public AdapterFilterPhong(Context context, ArrayList<ContructoFiltePhong> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContructoFiltePhong contructor = arrayList.get(position);
