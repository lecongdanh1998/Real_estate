...
public class ListViewHistoryDepositActivityAdapter extends BaseAdapter {
    ...
    public ListViewHistoryDepositActivityAdapter(ArrayList<ListViewMainActivityContructor> arrayList, Context context) {
