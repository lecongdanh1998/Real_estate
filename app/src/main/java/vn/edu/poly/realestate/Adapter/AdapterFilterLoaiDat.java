...
import vn.edu.poly.realestate.Model.ModelDangTinBatDongSan.ContructoFilterLoaiDat;
import vn.edu.poly.realestate.Model.ModelFilter.ContructoFilterChonhuong;
import vn.edu.poly.realestate.R;

public class AdapterFilterLoaiDat extends BaseAdapter {
    LayoutInflater inflater ;
    Context context;
    ArrayList<ContructoFilterLoaiDat> arrayList;

    public AdapterFilterLoaiDat(Context context, ArrayList<ContructoFilterLoaiDat> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContructoFilterLoaiDat contructor = arrayList.get(position);
