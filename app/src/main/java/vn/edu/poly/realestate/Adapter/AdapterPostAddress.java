...
public class AdapterPostAddress extends BaseAdapter {
    LayoutInflater inflater ;
    Context context;
    ArrayList<DataAddress> arrayList;

    public AdapterPostAddress(Context context, ArrayList<DataAddress> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataAddress contructor = arrayList.get(position);
