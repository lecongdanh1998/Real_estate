...
import vn.edu.poly.realestate.Model.ModelDangTinBatDongSan.ContructoFilteGiayChuQuyen;
import vn.edu.poly.realestate.Model.ModelFilter.ContructoFilterChonhuong;
import vn.edu.poly.realestate.R;

public class AdapterFilterGiayChuQuyen extends BaseAdapter {
    LayoutInflater inflater ;
    Context context;
    ArrayList<ContructoFilteGiayChuQuyen> arrayList;

    public AdapterFilterGiayChuQuyen(Context context, ArrayList<ContructoFilteGiayChuQuyen> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContructoFilteGiayChuQuyen contructor = arrayList.get(position);
