...
public class AdapterPostAddressWard extends BaseAdapter {
    LayoutInflater inflater ;
    Context context;
    ArrayList<DataAddressWard> arrayList;

    public AdapterPostAddressWard(Context context, ArrayList<DataAddressWard> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataAddressWard contructor = arrayList.get(position);
